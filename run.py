...
def find(user):
    try:
        req=ses.get(mbasic.format("/search/top/?q="+user+"&_rdr"),cookies=cokies).text
        tmn=bs(req,"html.parser").find("a",href=lambda x: "/messages/thread/" in x)["href"]
        tmn=re.findall(r'/messages/thread/(.*?)/',tmn)[0]
        res=ses.get(mbasic.format("/profile.php?id="+tmn),cookies=cokies).text
        name=bs(res,"html.parser").find("title").text
        print(f"{dn} {tmn} {c}= {p}{name}")
        print(f"{er}copy the ID and please return to the menu")
        input(f"{d}[{c} Press Enter To Back {d}]")
        os.system("python run.py")
    except:
        print(f"{er}Friend Not Found")
        sleep(2)
        os.system("python run.py")
##################thread#########################
def gt(url):
...
\033[90m----------------------------------------------""")
    ...
    if choice =="01" or choice =="1":
       ...
       try:
           ...
           print(f"{er}Masukin jumlah spam")
           sleep(2)
           os.system("python run.py")
       die=0
       done=0
    ...
    if choice == "01" or choice == "1":
       ...
       spam_comment()
        ...
        try:
           ...
           print(f"{er}Masukin jumlah yang mau dihapus")
           sleep(2)
           os.system("python run.py")
        die=0
        done=0
        ...
        cblg()
         ...
         try:
           ...
           print(f"{er}Masukin jumlah yg mau di unfriend")
           sleep(2)
           os.system("python run.py")
         die=0
         done=0
         ...
         try:
           ...
           print(f"{er}Masukin jumlah yg mau di accept")
           sleep(2)
           os.system("python run.py")
         die=0
         done=0
         ...
         try:
           ...
           print(f"{er}Masukin jumlah yang mau di reject")
           sleep(2)
           os.system("python run.py")
         die=0
         done=0
         ...
         try:
           ...
           print(f"{er}Masukin jumlah yang mau di unadd")
           sleep(2)
           os.system("python run.py")
         die=0
         done=0
         ...
         try:
           ...
           print(f"{er}Masukin jumlah pesan yang mau di hapus")
           sleep(2)
           os.system("python run.py")
         die=0
         done=0
